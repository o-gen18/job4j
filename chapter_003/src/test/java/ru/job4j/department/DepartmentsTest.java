...
public class DepartmentsTest {
    ...
    @Test
    public void whenFilledAndSortedInNaturalOrdering() {
        List<String> input = Arrays.asList("K1/SK1/SSK2", "K1/SK2", "K2/SK1/SSK1", "K1/SK1", "K2/SK1/SSK2", "K2", "K1/SK1/SSK1");
    ...
    @Test
    public void whenSortedInReverseOrdering() {
        List<String> input = Arrays.asList("K1/SK1/SSK2", "K1/SK2", "K2/SK1/SSK1", "K1/SK1", "K2/SK1/SSK2", "K2", "K1/SK1/SSK1");
